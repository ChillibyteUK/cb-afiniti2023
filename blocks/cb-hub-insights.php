<?php
/**
 * Block template for CB Hub Insights.
 *
...
<section class="hub_insights">
	<div class="container-xl pb-5">
		<h2 class="mb-4">Latest <?= esc_html( $hub_term->name ); ?> Insights and Case Studies</h2>
		<div class="hub_insights__grid">
			...
			while ( $q->have_posts() ) {
				...
				?>
			<a class="hub_insights__card" href="<?= esc_url( get_the_permalink() ); ?>">
				...
				<div class="hub_insights__inner">
					<div class="text--green fw-bold my-2"><?= esc_html( $n ); ?></div>
					<div class="fw-bold"><?= esc_html( get_the_title() ); ?></div>
