<?php
/**
 * Block template for CB Digital Transformation Diagram.
 *
			...
			<div class="col-lg-6 d-flex flex-column justify-content-around gap-2">
				<div class="bg--grey-100 p-2 dt_diagram__card">
					...
					<div class="dt_diagram__inner">
						...
						<p class="mb-2"><?= wp_kses_post( get_field( 'strategy_description' ) ); ?></p>
						<p class="mb-0"><em><?= wp_kses_post( get_field( 'strategy_strap' ) ); ?></em></p>
					</div>
				</div>
				<div class="bg--grey-100 p-2 dt_diagram__card">
					...
					<div class="dt_diagram__inner">
						...
						<p class="mb-2"><?= wp_kses_post( get_field( 'people_description' ) ); ?></p>
						<p class="mb-0"><em><?= wp_kses_post( get_field( 'people_strap' ) ); ?></em></p>
					</div>
				</div>
				<div class="bg--grey-100 p-2 dt_diagram__card">
					...
					<div class="dt_diagram__inner">
						...
						<p class="mb-2"><?= wp_kses_post( get_field( 'process_description' ) ); ?></p>
						<p class="mb-0"><em><?= wp_kses_post( get_field( 'process_strap' ) ); ?></em></p>
					</div>
				</div>
				<div class="bg--grey-100 p-2 dt_diagram__card">
					...
					<div class="dt_diagram__inner">
						...
						<p class="mb-2"><?= wp_kses_post( get_field( 'system_description' ) ); ?></p>
						<p class="mb-0"><em><?= wp_kses_post( get_field( 'system_strap' ) ); ?></em></p>
					</div>
				</div>
				<div class="bg--grey-100 p-2 dt_diagram__card">
					...
					<div class="dt_diagram__inner">
						...
						<p class="mb-2"><?= wp_kses_post( get_field( 'data_description' ) ); ?></p>
						<p class="mb-0"><em><?= wp_kses_post( get_field( 'data_strap' ) ); ?></em></p>
					</div>
				</div>
			</div>
		</div>
