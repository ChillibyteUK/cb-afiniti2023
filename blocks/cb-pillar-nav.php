	...
	<div class="container-xl">
		...
		<div class="row mb-5 g-4">
			<div class="col-12 col-lg-3">
				...
				<a
					href="<?= esc_url( get_field( 'shaping_link', 'options' ) ); ?>">
					<div class="bg--green-500 pillar-shadow">
						...
						<div class="text-white px-3 py-3">
							<div class="pillar-text">
								<?= wp_kses_post( get_field( 'shaping_intro', 'options' ) ); ?>
							</div>
			...
			<div class="col-12 col-lg-3">
				...
				<a
					href="<?= esc_url( get_field( 'readiness_link', 'options' ) ); ?>">
					<div class="bg--purple-500 pillar-shadow">
						...
						<div class="text-white px-3 py-3">
							<div class="pillar-text">
								<?= wp_kses_post( get_field( 'readiness_intro', 'options' ) ); ?>
							</div>
							<div class="fw-bold pt-4 pb-2">
			...
			<div class="col-12 col-lg-3">
				...
				<a
					href="<?= esc_url( get_field( 'delivering_link', 'options' ) ); ?>">
					<div class="bg--orange-500 pillar-shadow">
						...
						<div class="text-white px-3 py-3">
							<div class="pillar-text">
								<?= wp_kses_post( get_field( 'delivering_intro', 'options' ) ); ?>
							</div>
							<div class="fw-bold pt-4 pb-2">
								<div class="text-white anim-arrow--slide">Find
									out more <span class="arrow me-3"></span></div>
			...
			<div class="col-12 col-lg-3">
				...
				<a
					href="<?= esc_url( get_field( 'embedding_link', 'options' ) ); ?>">
					<div class="bg--grey-500 pillar-shadow">
						...
						<div class="text-white px-3 py-3">
							<div class="pillar-text">
								<?= wp_kses_post( get_field( 'embedding_intro', 'options' ) ); ?>
							</div>
							<div class="fw-bold pt-4 pb-2">
								<div class="text-white anim-arrow--slide">Find out
									more <span class="arrow me-3"></span></div>
