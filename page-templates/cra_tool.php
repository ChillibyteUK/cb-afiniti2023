...
<div class="container-xl">
    ...
    <section class="stepCard" id="form1">
        ...
        <div class="form_panel">
            <div class="form_grid">
                ...
                <div>&nbsp;</div>
                <div>
                    <label for="consent"><input type="checkbox" name="consent" id="consent" value="true"> <div>I consent to the terms of the <a href="/privacy-policy/" target="_blank">privacy policy</a><sup>*</sup>.</div></label>
    ...
    <section class="stepCard" id="form2">
        ...
        <div class="form_panel">
            <div class="form_grid mb-3">
                <label for="changeInProgress">Is your organisation currently implementing or planning a major change initiative?</label>
                <div>
    ...
    <section class="stepCard" id="form3">
        ...
        <div class="form_panel">
            <div class="alert alert-light"><?=get_field('question_header')?></div>
            <div class="form_grid form_grid--wide">
                ...
                while (have_rows('questions_page_1')) {
                    the_row();
                    ?>
                    <label for="form3_answers"><?=get_sub_field('question')?><!-- [<?=get_sub_field('lever')?>] --></label>
                    <?=$mobLabels?>
                    <div class="radio_group">
                        <?php
                        for ($i = 1; $i <= 10; $i++) {
                            ?>
                        <input type="radio" name="form3_answers_<?=$q?>" data-lever="<?=get_sub_field('lever')?>" value="<?=$i?>" class="form-check">
                            <?php
                        }
                        ?>
                    </div>
        ...
        <div class="form_panel">
            ...
            <div class="form_grid form_grid--wide">
                ...
                while (have_rows('questions_page_2')) {
                    the_row();
                    ?>
                    <label for="form4_answers"><?=get_sub_field('question')?><!-- [<?=get_sub_field('lever')?>] --></label>
                    <?=$mobLabels?>
                    <div class="radio_group">
                        <?php
                        for ($i = 1; $i <= 10; $i++) {
                            ?>
                        <input type="radio" name="form4_answers_<?=$q?>" data-lever="<?=get_sub_field('lever')?>" value="<?=$i?>" class="form-check">
                            <?php
                        }
                        ?>
                    </div>
        ...
        <div class="form_panel">
            ...
            <div class="form_grid form_grid--wide">
                ...
                while (have_rows('questions_page_3')) {
                    the_row();
                    ?>
                    <label for="form5_answers"><?=get_sub_field('question')?><!-- [<?=get_sub_field('lever')?>] --></label>
                    <?=$mobLabels?>
                    <div class="radio_group">
                        <?php
                        for ($i = 1; $i <= 10; $i++) {
                            ?>
                        <input type="radio" name="form5_answers_<?=$q?>" data-lever="<?=get_sub_field('lever')?>" value="<?=$i?>" class="form-check">
                            <?php
                        }
                        ?>
                    </div>
            ...
            <div class="form_buttons text-end">
                <form action="<?=get_stylesheet_directory_uri()?>/cra.php" method="post">
